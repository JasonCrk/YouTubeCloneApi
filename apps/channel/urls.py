...
urlpatterns = [
    path('subscribed', views.RetrieveSubscribedChannelsView.as_view(), name='subscribed_channels'),
    ...
    path('by-id/<pk>', views.RetrieveChannelDetailsByIdView.as_view(), name='channel_details_by_id'),
    path('by-handle/<str:channel_handle>', views.RetrieveChannelDetailsByHandleView.as_view(), name='channel_details_by_handle'),
