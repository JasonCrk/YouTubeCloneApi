...
from tests.factories.video import VideoFactory, LikeVideoFactory
...
class TestLikeVideo(TestSetup):
    ...
    def test_to_return_success_response_if_the_like_video_has_been_successful(self):
    ...
    def test_to_check_if_the_like_video_has_been_successful(self):
        self.client.post(
            self.url,
            {
                'video_id': self.test_video.pk
        ...
        like_comment_exists = LikedVideo.objects.filter(
    ...
    def test_to_return_success_response_if_the_like_video_has_been_successful_deleted(self):
    ...
    def test_to_check_if_the_like_video_has_been_successful_deleted(self):
        LikeVideoFactory.create(
            channel=self.user.current_channel,
            video=self.test_video
        )
